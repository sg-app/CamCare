    ...
    public class AppDbContext(DbContextOptions<AppDbContext> options) : DbContext(options), IAppDbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<RepairOrderStatus>()
                .HasData(
                    new RepairOrderStatus { Id = 1, Order = 1, Name = "In Anlieferung", Description="Reparatur wurde von Kunden angemeldet." , BackgroundColor = "rgb(206, 206, 206)", FontColor = "rbg(0, 0, 0)" },
                    ...
                    new RepairOrderStatus { Id = 4, Order = 4, Name = "Begutachtung abgeschlossen", Description = "Begutachtung wurde vom Mitarbeiter abgeschlosen.", BackgroundColor = "rgb(76, 170, 232)", FontColor = "rbg(0, 0, 0)" },
                    ...
                    new RepairOrderStatus { Id = 9, Order = 9, Name = "Versendet", Description = "Kamera wurde versendet.", BackgroundColor = "rgb(125, 218, 88)", FontColor = "rbg(0, 0, 0)" }
                );
